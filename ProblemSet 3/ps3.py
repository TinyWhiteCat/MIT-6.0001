    ...
    * The hand finishes when there are no more unused letters.
    ...
    while hand != {}:
        ...
        if is_valid_word(userinput, hand, word_list):
            ...
            total_score += score
            print("'", userinput, "'", "earned", score, "points. Total:", total_score, "points")
        else:
...
#
def get_rondam_letter():
    new_hand = deal_hand(2)
    new_letter = ''
    for i in new_hand:
        if i != '*':
            new_letter = i
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    game_numbers = int(input("Enter total number of hands:"))
    ...
    while time < game_numbers:
        score = 0
        replay_score = 0
        
        if substitute_chance == 1:
            userinput = input("Would you like to substitute a letter?")
        ...
        if replay_chance == 1:
            userinput = input("Would you like to replay the hand? ")
            userinput = userinput.lower()
            if userinput == "yes":
